      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          <h2 className="font-display text-3xl md:text-5xl font-bold mb-4">
            <span className="text-accent">LUDI</span><span className="text-foreground">GAMI</span> se plie en <span className="gradient-text">quatre</span> <br />pour la réussite de vos événements !
          </h2>
