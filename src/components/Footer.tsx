...
const footerLinks = {
  services: [
    { name: "Programme de Gamification", href: "#" },
        ...
        <div className="grid lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm leading-relaxed">
              Leader français de la gamification marketing pour commerces physiques. 
              Nous transformons l'expérience client depuis 2018.
            </p>
            <div className="space-y-3">
              <a href="mailto:contact@gameeventpro.fr" className="flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors">
                <Mail className="w-4 h-4" />
                contact@gameeventpro.fr
              </a>
              <a href="tel:+33123456789" className="flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors">
